...
const PreviewStep: React.FC<StepProps> = ({ formData }) => {
  const { personalInfo, targetYear, commitment } = formData;
    ...
    >
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        >
          <div className="form-grid form-grid-2">
            ...
            <div>
              <strong>Optional Subject:</strong> {commitment.upscOptionalSubject}
            </div>
            <div>
              <strong>Study Approach:</strong> {commitment.subjectApproach}
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <div className="form-grid form-grid-1">
          {[
            { name: 'Foundation Phase', description: 'NCERT and basic concepts', duration: '3 months' },
            { name: 'Comprehensive Phase', description: 'Deep dive into all subjects', duration: '6 months' },
            { name: 'Prelims Preparation', description: 'Focus on prelims-specific content', duration: '2 months' },
            { name: 'Prelims Revision', description: 'Intensive revision and practice tests', duration: '1 month' },
            { name: 'Mains Preparation', description: 'Transition to mains preparation', duration: '3 months' },
            { name: 'Final Revision', description: 'Final preparation for mains exam', duration: '1 month' }
          ].map((cycle, index) => (
            <div 
              key={index}
              style={{
