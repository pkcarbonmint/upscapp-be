  ...
  private static async convertStudyMaterialsToResources(subjectCode: string, studyMaterials: StudyMaterial[]): Promise<SubjectResourcesFile> {
    ...
    if (subjectCode.startsWith('OPT-') && !subject) {
      ...
      const codeMap: Record<string, string> = {
        'OPT-AGR': 'Agriculture',
        'OPT-AHV': 'Animal Husbandry and Veterinary Science',
        'OPT-ANT': 'Anthropology',
        'OPT-BOT': 'Botany',
        'OPT-CHE': 'Chemistry',
        'OPT-CE': 'Civil Engineering',
        'OPT-COM': 'Commerce and Accountancy',
        'OPT-ECO': 'Economics',
        'OPT-EE': 'Electrical Engineering',
        'OPT-GEO': 'Geography',
        'OPT-GEOL': 'Geology',
        'OPT-HIS': 'History',
        'OPT-LAW': 'Law',
        'OPT-MGT': 'Management',
        'OPT-MAT': 'Mathematics',
        'OPT-ME': 'Mechanical Engineering',
        'OPT-MED': 'Medical Science',
        'OPT-PHI': 'Philosophy',
        'OPT-PHY': 'Physics',
        'OPT-PSIR': 'Political Science and International Relations',
        'OPT-PSY': 'Psychology',
        'OPT-PA': 'Public Administration',
        'OPT-SOC': 'Sociology',
        'OPT-STA': 'Statistics',
        'OPT-ZOO': 'Zoology',
        'OPT-ASM': 'Assamese Literature',
        'OPT-BEN': 'Bengali Literature',
        'OPT-BOD': 'Bodo Literature',
        'OPT-DOG': 'Dogri Literature',
        'OPT-GUJ': 'Gujarati Literature',
        'OPT-HIN': 'Hindi Literature',
        'OPT-KAN': 'Kannada Literature',
        'OPT-KAS': 'Kashmiri Literature',
        'OPT-KON': 'Konkani Literature',
        'OPT-MAI': 'Maithili Literature',
        'OPT-MAL': 'Malayalam Literature',
        'OPT-MAN': 'Manipuri Literature',
        'OPT-MAR': 'Marathi Literature',
        'OPT-NEP': 'Nepali Literature',
        'OPT-ODI': 'Odia Literature',
        'OPT-PUN': 'Punjabi Literature',
        'OPT-SAN': 'Sanskrit Literature',
        'OPT-SANT': 'Santhali Literature',
        'OPT-SIN': 'Sindhi Literature',
        'OPT-TAM': 'Tamil Literature',
        'OPT-TEL': 'Telugu Literature',
        'OPT-URD': 'Urdu Literature',
        'OPT-ENG': 'English Literature'
      };
