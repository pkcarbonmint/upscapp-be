import { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, WidthType, BorderStyle, Header, Footer, PageBreak, PageNumber } from 'docx';
...
import wordStyles, { DOCUMENT_STYLES, TABLE_STYLE_NAMES } from './word-styles';
