...
async def get_plantask_with_plantaskusers(studyplan_id:int):
...
async def create_studyplanuser(*,studyplanuser_in:StudyPlanUserCreate):
...
async def create_studyplan_for_purchases(*,studyplanuser_in:PurchaseStudyplanCreate): #when studyplan is created assign them to all purchases which bought studyplan's product
...
async def create_plantaskusers(*,plantask_in:PlanTaskUserCreate):
...
async def assign_plantasks_for_purchase(*,plantask_in:PurchasePlantaskCreate):
...
async def assign_plantask_to_purchases(*, plantask_in:AssignPlantaskUser):
...
async def assign_plantask_to_purchases(*, plantask_in:AssigntasktoSelectStudents):
...
async def get_plantasks_by_date( plantask: PlanTaskDate):
...
async def get_plantasks_by_products( plantask: PlanTaskByProd):
...
async def get_plantasks_by_purchases( user_id:int,plantask: PlanTaskByPur):
...
async def get_plantasks_userstatus(status: TASK_STATUS):
...
async def get_plantask_student_tests(task_test:StudentTasksTests ):
...
async def get_new_tasks_tests(task_test:TasksNewTests):
...
async def get_tasks_tests_by_attempt_status(task_test:TasksAttemptTests):
...
async def get_plantask_student_tests(student_id:int,product_id:int | None = None):
...
async def get_student_products(student_id:int):
...
async def get_student_product(student_id:int,purchase_id:int):
...
async def get_upcoming_products(student_id:int,prod_name: str | None = None,prod_code: str | None = None,offering_name:str| None = None,offering_category: str| None = None,branch_id:int| None = None,offering_id:int | None = None):
...
async def get_inprogress_products(student_id:int,prod_name: str | None = None,prod_code: str | None = None,offering_name:str| None = None,offering_category: str| None = None,branch_id:int| None = None,offering_id:int | None = None):
...
async def get_completed_products(student_id:int,prod_name: str | None = None,prod_code: str | None = None,offering_name:str| None = None,offering_category: str| None = None,branch_id:int| None = None,offering_id:int | None = None):
