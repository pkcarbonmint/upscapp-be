...
class SessionBreakUp(BaseSchema):
...
class PriceUpdate(PriceBase):
    ...
    session_break_up: list[SessionBreakUp]  | None = None
...
class PurchasesCreate(BaseSchema):
    ...
    product_sessions: SessionBreakUp | None = None
...
class AdmissionEnrollmentCreate(BaseSchema):
    student_id:int
    walkin_id: int | None = None
...
class AdmissionEnrollmentPurResp(BaseSchema):
