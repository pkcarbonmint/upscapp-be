    ...
    async def get_user_products_with_studyplans_upcoming(
        ...
        query = (
            ...
            .where(and_(
                    ...
                    #  # QBANK-specific purchase_date cutoff
                    or_(
                        Offering.offering_sub_type != "QBANK",
                        and_(
                            Offering.offering_sub_type == "QBANK",
        ...
        query = (
            ...
            .where( and_(
                    ...
                    or_(
                        ...
                        and_(
                            Offering.offering_sub_type == "QBANK",
                            Purchase.purchase_date >= case(
                            (cast(Product.product_details["q_bank_info"].op("->>")("time_period"), String) == "MONTH", today_date - timedelta(days=30)),
                            (cast(Product.product_details["q_bank_info"].op("->>")("time_period"), String) == "QUARTER", today_date - timedelta(days=90)),
                            (cast(Product.product_details["q_bank_info"].op("->>")("time_period"), String) == "YEAR", today_date - timedelta(days=365)),
                            else_=today_date
                        )
                        )
                    ),
