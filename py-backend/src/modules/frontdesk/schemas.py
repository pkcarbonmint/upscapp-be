...
from src.modules.products.schemas import OFFERING_CATEGORY, WALKINFORM_TYPE, ProductResponse, PurchaseReponse
from src.tenants.schemas import BranchResponse
from src.users.schemas import UserBasicInfo, UserResponse
...
class WalkinResponse(WalkinUpdate):
    ...
    created_at: datetime | None = None
    updated_at: datetime | None = None
    admissions: list[WalkinAdmissionResponse] | None = None

class WalkinCountResp(BaseSchema):
    seq_id: int | None = None
    Walkin: WalkinResponse
...
class CounsellingDetails(BaseSchema):
    counsellor_name: str | None = None
...
class AdmissionInfo(BaseSchema):
    user_id:int | None = None
...
class UserAdmissionInfo(BaseSchema):
    id: int
...
class AdmissionResp(AdmissionCreate):
    id: int
    user: UserAdmissionInfo | None = None
    is_dropout: bool | None = None
    dropout_reason: str | None = None
    Branch: BranchResponse | None = None
    created_at: datetime | None = None
...
class AdmissionReportDetails(BaseSchema):
    due_amount: int | None = None
    Purchase: PurchaseReponse
    Product: ProductResponse
    Admission: AdmissionResp

class AdmissionUnrealized(BaseSchema):
    pass

class ConversionData(BaseSchema):
    from_date: date | None = None
    till_date: date | None = None 
    offering_name: str | None = None 
    counsellor_name: str | None = None 

class CounsellorData(BaseSchema):
    from_date: date | None = None
    till_date: date | None = None
    counsellor_id: int | None = None 
