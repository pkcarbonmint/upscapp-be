...
class MATERIAL_TYPE(str, Enum):
    ...
    mains_questions_issues = "Mains Questions (from Issues)"
    prelims_questions_issues = "Prelims Questions (from Issues)"
...
class PrelimsFactSheetQuestionSchema(BaseSchema):
    id: int  | None = None
    multiple_choice_question: MCQSchema | None = None
    context_question: CQSchema 
    prelims_fact_sheet: PrelimsFactSheetSchema
    review_status: REVIEW_STATUS

class PrelimsFactSheetQuestionCreate(BaseSchema):
    multiple_choice_question: int | None = None
    context_question: int | None = None
    prelims_fact_sheet: int | None = None
...
class subtopic(BaseSchema):
    id:int
    name:str

class SubjectTopicIds(BaseSchema):
    subject: subtopic
    topics: list[subtopic] | None = None
...
class PYQMainsSchema(BaseSchema):
    ...
    subject_topics: list[SubjectTopicIds] | None = None

class PYQPrelimsSchema(BaseSchema):
    pyq_start_date: int
    pyq_end_date: int
    tenant_id:int
    category:str | None = None
    ...
    paper_ids:list[int] | None = None
    subject_topics: list[SubjectTopicIds] | None = None
    current_affairs_topics: list[subtopic] | None = None