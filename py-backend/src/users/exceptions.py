...
class ErrorCode:
    ...
    PRODUCT_ACCESS = "Product expired"
    NO_PRODUCT_ACCESS = "No active products available"
    DISCOUNT_EXISTS = "Discount with code already exists."
    NO_PHOTO_UPDATE_ACCESS = "Profile photo is locked. Permission denied"
...
class ProductExpired(DetailedHTTPException):
    STATUS_CODE = status.HTTP_403_FORBIDDEN
    DETAIL = ErrorCode.PRODUCT_ACCESS

class NoProduct(DetailedHTTPException):
    STATUS_CODE = status.HTTP_403_FORBIDDEN
    DETAIL = ErrorCode.NO_PRODUCT_ACCESS
...
class UpdatePhotoDenied(DetailedHTTPException):
    STATUS_CODE = status.HTTP_403_FORBIDDEN
    DETAIL = ErrorCode.NO_PHOTO_UPDATE_ACCESS
